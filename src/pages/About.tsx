  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <Card className="h-full gradient-card border-0 shadow-card hover-lift">
                    <CardContent className="p-8">
                      <div className="flex items-start space-x-4">
                        <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${value.gradient} flex items-center justify-center shadow-warm flex-shrink-0`}>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <div className="gradient-card rounded-3xl p-12 shadow-warm">
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">
              ...
              <a 
                href="/workspace" 
                className="inline-flex items-center px-8 py-4 text-lg font-medium rounded-full gradient-warm text-primary-foreground shadow-warm hover-lift transition-all duration-300"
              >
